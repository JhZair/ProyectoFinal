...
def actualizar_jugador(jugador, teclas, izq, derecha, salto, defensa):
    if teclas[izq]:
...
while ejecutando:
    ...
    actualizar_jugador(jugador1, teclas, pygame.K_a, pygame.K_d, pygame.K_w, pygame.K_s)
    actualizar_jugador(jugador2, teclas, pygame.K_LEFT, pygame.K_RIGHT, pygame.K_UP, pygame.K_DOWN)
